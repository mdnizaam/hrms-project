...
function Hr() {
  ...
  <path d="M12 3H4a1 1 0 0 0-1 1v2.5H2V4a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v2.5h-1V4a1 1 0 0 0-1-1zM2 9.5h1V12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V9.5h1V12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V9.5zm-1.5-2a.5.5 0 0 0 0 1h15a.5.5 0 0 0 0-1H.5z"/>
                    ...
                    <div className={`col-lg-${state12} col-md-${state12} col-sm-${state12}`} style={{ backgroundColor: "#E5E7EB" }}>
                        ...
                        <div ><h1 className="bill my-5 mx-4">HR Dashboard</h1></div>
                        ...
                        <div className="row">
                            ...
                            <div className="col-6">
                                ...
                                <div className="container-fluid">
                                    <div className="row">
                                        <div className='col-lg-6 bg-dark text-light py-5 ms-5 '>
                                                        ...
                                                        <table class="table table-light table-striped">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>23-07-2021</td>
                                                                    <td>Active</td>
                                                                    <td><NavLink className="btn btn-primary me-2 " to="/maindashboard">
                                                                        View
                                                                    </NavLink>
                                                                        <NavLink
                                                                        ...
                                                                        {/* <NavLink
                                                                            className="btn btn-outline-danger me-2" to="">
                                                                            Delete
                                                                        </NavLink> */}
  ...
  <table class="table table-light table-striped">
    ...
    <tbody>
      <tr>
        ...
        <td><NavLink className="btn btn-primary " to="">
                    View
                  </NavLink>
                  <NavLink
                    className="btn btn-outline-primary" to="">
                    Edit
                  </NavLink>
                  <NavLink
                    className="btn btn-outline-danger" to="">
                    Delete
                  </NavLink>
