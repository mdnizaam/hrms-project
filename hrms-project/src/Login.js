...
function Login() {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('http://api.localhost:8000/v1/clients/web/admin/login', data)
            ...
            <div className="container-fluid">
                <div className="row">
                    ...
                    <div className={`col-lg-${state12} col-md-${state12} col-sm-${state12}`} style={{ backgroundColor: "#E5E7EB" }}>
                        ...
                        <div ><h1 className="bill my-5 mx-4">Login Form</h1></div>
                        ...
                        <div className="row  justify-content-center my-5">
                            <div className="col-6 mx-5 ">
                                ...
                                <form onSubmit={(e) => handleSubmit(e)} className="was-validated">
                                    <div className="mb-3 infont ">
                                        <label htmlFor="exampleFormControlInput1" className="form-label">E-Mail Address</label>
                                        <input type="email" className="form-control" id="email" placeholder="Enter Your E-Mail Address" name="email" value={email} onChange={(e) => setEmail(e.target.value)} required />
                                    </div>


                                    <div className="mb-3 infont ">
                                        <label htmlFor="password" className="form-label">Password</label>
                                        <input type="password" className="form-control" id="password" placeholder="Enter Your Password" value={password} name="password" onChange={(e) => setPassword(e.target.value)} required />
                                    </div>
